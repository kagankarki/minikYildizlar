        ...
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href={SITE.whatsappHref} target="_blank" rel="noreferrer" className="btn-whatsapp !px-6 !py-2.5 !text-[0.68rem]">
                WhatsApp
              </a>
              <a href={SITE.instagram} target="_blank" rel="noreferrer" className="btn-instagram !px-6 !py-2.5 !text-[0.68rem]">
                Instagram
              </a>
            </div>
          </div>
