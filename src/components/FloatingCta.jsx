...
export default function FloatingCta() {
  ...
  return (
    <div className={`fixed bottom-5 right-5 z-40 flex flex-col gap-3 transition-all duration-500 sm:bottom-8 sm:right-8 ${show ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-6 opacity-0"}`}>
      <a
        href={SITE.whatsappHref}
        target="_blank"
        rel="noreferrer"
        aria-label="WhatsApp'tan yazın"
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_14px_40px_-10px_rgba(37,211,102,0.8)] transition-transform duration-500 hover:scale-105"
      >
